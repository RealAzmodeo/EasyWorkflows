...
const anime2realismTemplate = {
    ...
    "435": { "inputs": { "value": "" }, "class_type": "PrimitiveStringMultiline" },
...
export const workflows = [
    {
        ...
        description: 'Transform anime style images into realistic photos using Qwen 2509.',
        inputs: [
            {
                id: 'input_image',
                type: 'image',
                label: 'Source Image',
                target: { nodeId: '78', field: 'image' }
            },
            {
                id: 'prompt',
                type: 'text',
                label: 'Prompt',
                defaultValue: 'changed the image into realistic photo',
                target: { nodeId: '435', field: 'value' }
            },
            {
                id: 'seed',
                type: 'number',
                ...
                target: { nodeId: '433:3', field: 'seed' }
            }
        ],
    ...
    },
    {
        id: 'faceswap',
        name: 'Face Swap',
        description: 'Replace face in target image with source face.',
        inputs: [
            {
                id: 'body_image',
                type: 'image',
                label: 'Body/Target Image',
                target: { nodeId: '78', field: 'image' }
            },
            {
                id: 'face_image',
                type: 'image',
                label: 'Face Source',
                target: { nodeId: '438', field: 'image' }
            },
            {
                id: 'prompt',
                type: 'text',
                label: 'Prompt',
                defaultValue: 'h34d_sw4p: replace the head...',
                target: { nodeId: '435', field: 'value' }
            },
            {
                id: 'seed',
